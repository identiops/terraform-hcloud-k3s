...
- [7ce2b45](https://github.com/identiops/terraform-hcloud-k3s/commit/7ce2b45c66199885275da05b1364c052c67d4507) Add file-based k3s config layering

### Bug Fixes

- [f732ef5](https://github.com/identiops/terraform-hcloud-k3s/commit/f732ef53de694130d3787bdc0a98371c5f9192b1) Add gateway public IP to tls-san
- [180fcf8](https://github.com/identiops/terraform-hcloud-k3s/commit/180fcf8a43c8782c38db43da005cc7c28807691e) Add IPv6 to tls-san for gateway public IP

### Documentation

- [add616e](https://github.com/identiops/terraform-hcloud-k3s/commit/add616e563a43b7f71c2dfcc314b76f32c12d44e) Extend troubleshooting and add k3s config merge docs

### Miscellaneous Tasks

- [17f0d0e](https://github.com/identiops/terraform-hcloud-k3s/commit/17f0d0e7740835e446aa9077a76094eec241d40a) Update helm release cilium to v1.19.3
- [e1a0d15](https://github.com/identiops/terraform-hcloud-k3s/commit/e1a0d15e91951df735cf4c5b8515801c0d1894e3) Update helm release hcloud-csi to v2.20.2
- [7f2dc9b](https://github.com/identiops/terraform-hcloud-k3s/commit/7f2dc9be927f3be87617629e3cd82880a811b97a) Update dependency nushell/nushell to v0.112.2
- [db53f8a](https://github.com/identiops/terraform-hcloud-k3s/commit/db53f8a5974f997a3301dcfcea6f6ad57cc7fd54) Update helm release hcloud-cloud-controller-manager to v1.31.0
- [9435891](https://github.com/identiops/terraform-hcloud-k3s/commit/9435891129a987787b57ade0e72760fe609d3496) Update dependency rancher/system-upgrade-controller to v0.19.2
- [5b907c3](https://github.com/identiops/terraform-hcloud-k3s/commit/5b907c33c1c722bcc102c06436d125a7434bd335) Update update-controller to version 0.19.1
- [12fb30c](https://github.com/identiops/terraform-hcloud-k3s/commit/12fb30c11cb058f68d9c8274bea81ff31773bdd0) Update helm release system-upgrade-controller to v109.0.1
- [9216be1](https://github.com/identiops/terraform-hcloud-k3s/commit/9216be1a0e56e941e88af7038238db4435db6dc9) Update terraform hcloud to ~> 1.62.0
- [2090bed](https://github.com/identiops/terraform-hcloud-k3s/commit/2090bed4583fd4778f869965cdec84d459b7dca1) Update terraform hcloud to ~> 1.63.0
- [8670474](https://github.com/identiops/terraform-hcloud-k3s/commit/86704749a91ede9681cd4febbb84a002effe573e) Update helm release hcloud-csi to v2.21.0
- [77b5890](https://github.com/identiops/terraform-hcloud-k3s/commit/77b589011961acdfd19803f6a10cfd153a4da5bf) Update terraform time to ~> 0.14.0
- [8e68110](https://github.com/identiops/terraform-hcloud-k3s/commit/8e68110cc473685db59f71d898db71b33e560a4e) Update terraform local to ~> 2.9.0
- [5aaf316](https://github.com/identiops/terraform-hcloud-k3s/commit/5aaf316106c5be6d23197c3b4ea1e0e1ca649461) Update terraform http to ~> 3.6.0
- [eef29c1](https://github.com/identiops/terraform-hcloud-k3s/commit/eef29c11e637f9308f5363c2e32f3eaba3fdcd43) Update terraform random to ~> 3.9.0
- [dc68b82](https://github.com/identiops/terraform-hcloud-k3s/commit/dc68b8227207cb608f9a62ce0712f400a66cde9c) Update dependencies
